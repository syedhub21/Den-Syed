  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ width: "min(85vw, 280px)", height: "min(65vh, 480px)" }}
      >
        <svg
          viewBox="0 0 200 520"
          className="absolute inset-0 w-full h-full"
          role="img"
          aria-label="Floor lamp — drag the chain down to turn on"
        >
          {/* Shade */}
          <motion.ellipse
          ...
          {/* Stem */}
          <rect x="98" y="48" width="4" height="400" fill="hsl(0 0% 14%)" />
          <motion.rect
            x="99" y="48" width="1" height="400"
          ...
          {/* Base */}
          <ellipse cx="100" cy="460" rx="42" ry="9" fill="hsl(0 0% 10%)" />
          <motion.ellipse
            cx="100" cy="458" rx="40" ry="6"
            fill={lightIntensity > 0 ? `hsl(38 50% ${20 + lightIntensity * 15}%)` : "hsl(0 0% 6%)"}
          />
        </svg>

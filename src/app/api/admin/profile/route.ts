...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    const data = {
      ...
      nowWorkingOn: String(body.nowWorkingOn ?? ""),
      nowCurrently: String(body.nowCurrently ?? ""),
      nowReading: String(body.nowReading ?? ""),
      quoteText: String(body.quoteText ?? ""),
      quoteAttribution: String(body.quoteAttribution ?? ""),

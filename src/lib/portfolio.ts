  ...
  if (profileCount === 0) {
    await db.profile.create({
      data: {
        ...
        manifesto: SEED_DATA.profile.manifesto,
        nowWorkingOn: SEED_DATA.profile.nowWorkingOn,
        nowCurrently: SEED_DATA.profile.nowCurrently,
        nowReading: SEED_DATA.profile.nowReading,
        quoteText: SEED_DATA.profile.quoteText,
        quoteAttribution: SEED_DATA.profile.quoteAttribution,
  ...
  try {
    ...
    const profile: Profile = profileRow
      ? {
          ...
          bio: profileRow.bio,
          manifesto: profileRow.manifesto || SEED_DATA.profile.manifesto,
          nowWorkingOn: profileRow.nowWorkingOn || SEED_DATA.profile.nowWorkingOn,
          nowCurrently: profileRow.nowCurrently || SEED_DATA.profile.nowCurrently,
          nowReading: profileRow.nowReading || SEED_DATA.profile.nowReading,
          quoteText: profileRow.quoteText || SEED_DATA.profile.quoteText,
          quoteAttribution: profileRow.quoteAttribution || SEED_DATA.profile.quoteAttribution,
